...
python ./transformers/examples/question-answering/run_squad.py --model_type convbert --model_name_or_path 'E:/ConvbertData/convbert/model_dir' --do_train --do_eval --do_lower_case --train_file E:/ConvbertData/squad_data/v2/train-v2.0.json --predict_file E:/ConvbertData/squad_data/v2/dev-v2.0.json --per_gpu_train_batch_size 16 --learning_rate 3e-5 --num_train_epochs 3.0 --max_seq_length 384 --doc_stride 128 --output_dir E:/ConvbertData/squad_models/conbert/v2/ --overwrite_output_dir --evaluate_during_training


python ./transformers/examples/question-answering/run_squad.py --model_type albert --model_name_or_path 'E:/ConvbertData/albert3/model_dir' --do_train --do_eval --do_lower_case --train_file E:/ConvbertData/squad_data/v2/train-v2.0.json --predict_file E:/ConvbertData/squad_data/v2/dev-v2.0.json --per_gpu_train_batch_size 16 --learning_rate 3e-5 --num_train_epochs 1.0 --max_seq_length 384 --doc_stride 128 --output_dir E:/ConvbertData/squad_models/albert/v2/ --overwrite_output_dir