...
config = AlbertConfig(hidden_size=768, num_attention_heads=12, intermediate_size=3072, attention_probs_dropout_prob=0, num_hidden_groups=4, num_hidden_layers=8)
...
train_dataset = SOPDataset(directory='E:/ConvbertData/text_data2/cache', batch_size=1, tokenizer=tokenizer, mlm_probability=0.15)
